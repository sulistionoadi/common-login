...
public class MasterUserRestApi {
	...
	@GetMapping("/draw")
	@PreAuthorize("hasAuthority('API_DRAW_USER')")
	public ResponseEntity<DatatableResponse> dataUser(PssFilter filter) throws Exception{
	...
	@GetMapping("/fetch")
	@PreAuthorize("hasAuthority('API_DRAW_USER')")
	public ResponseEntity<DatatableResponse> fetchUser(PssFilter filter) throws Exception{
	...
	public ResponseEntity<DefaultResponse> saveKeyword(@RequestBody MasterUserDTO dto) throws CommonException {
	...
	public ResponseEntity<DefaultResponse> deleteUser(@PathVariable Long id) throws CommonException {
	...
	@GetMapping("/select2")
	@PreAuthorize("hasAuthority('API_DRAW_USER')")
	public ResponseEntity<Select2Response> dataSelect2 (
	...
	@PreAuthorize("hasAuthority('API_DRAW_USER')")
	public ResponseEntity<DefaultResponse> fetchByKeyword(@PathVariable String name) throws CommonException {
	...
	@PreAuthorize("hasAuthority('API_SAVE_KEYWORD')")
	public ResponseEntity<DefaultResponse> setStatus(@PathVariable Long id, 
		...
		service.setActive(id, isActive, null);
